      ...
      <div className='max-w-7xl mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-0  md:divide-x divide-gray-400'>
          ...
          <div className='text-center px-8 py-12 md:py-8'>
            <div className='mb-6'>
              <img src="/images/Home/mission.png" alt="Our Mission" className='w-16 h-16 mx-auto object-contain' />
            </div>
          ...
          <div className='text-center px-8 md:py-8 max-w-[80vw]'>
            <div className='mb-6'>
              <img src="/images/Home/plan.png" alt="Our Plan" className='w-16 h-16 mx-auto object-contain' />
            </div>
          ...
          <div className='text-center px-8 py-12 md:py-8'>
            <div className='mb-6'>
              <img src="/images/Home/vision.png" alt="Our Vision" className='w-16 h-16 mx-auto object-contain' />
            </div>
